...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	var oppNoteSkinInputText:FlxUIInputText;
	...
	function addDataUI()
	{
		...
		tab_group_data.add(oppNoteSkinInputText);
		...
		tab_group_data.add(new FlxText(noteSkinInputText.x, noteSkinInputText.y - 15, 0, 'Player Note Texture:'));
		tab_group_data.add(new FlxText(oppNoteSkinInputText.x, oppNoteSkinInputText.y - 15, 0, 'Opponent Note Texture:'));
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		...
		else if (id == FlxUINumericStepper.CHANGE_EVENT && (sender is FlxUINumericStepper))
		{
			...
			else if(sender == oppNoteSkinInputText) {
				_song.oppArrowSkin = oppNoteSkinInputText.text;
			}
