...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set('holdSplashPlayer', game.grpHoldSplashes);
		set('holdSplashOpponent', game.grpOpponentHoldSplashes);
		...
		Lua_helper.add_callback(lua, "holdSplashTweenAlpha", function(tag:String, type:String, value:Dynamic, duration:Float, ease:String) {
			LuaUtils.cancelTween(tag);
			var testicle:FlxTypedSpriteGroup<SustainSplash>;
			switch(type){
				case 'player':
					testicle = game.grpHoldSplashes;
				case 'opponent':
					testicle = game.grpOpponentHoldSplashes;
				default:
					testicle = game.grpHoldSplashes;
			}
